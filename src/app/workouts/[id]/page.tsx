...
import { ArrowLeft, Heart, Clock, Users, Play, Edit, Loader2 } from 'lucide-react'
...
export default function WorkoutPage({ params }: PageProps) {
  ...
  const { toggleFavorite, completeWorkout, loading: mutationLoading } = useWorkoutMutations()
  ...
  const handleFavoriteToggle = async () => {
    ...
    try {
      ...
      toast.success(workout.isFavorite ? 'Removed from favorites' : 'Added to favorites!')
    } catch (error) {
        ...
        <div className="grid grid-cols-3 gap-4">
          <Card>
            <CardContent className="flex flex-col items-center justify-center p-4">
              ...
              <p className="text-sm font-medium">{Math.round(estimatedDuration)}m</p>
          ...
          <Card>
            <CardContent className="flex flex-col items-center justify-center p-4">
              ...
              <p className="text-sm font-medium">{workout.exercises?.length || 0}</p>
          ...
          <Card>
            <CardContent className="flex flex-col items-center justify-center p-4">
              ...
              <p className="text-sm font-medium">{workout.completionCount || 0}</p>
